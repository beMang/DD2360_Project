...
int main(int argc, char* argv[]) {
    ...
    checkCudaErrors(cudaMallocManaged((void **)&d_rand_state, num_pixels*sizeof(curandState))); //regular malloc
    curandState *d_rand_state2;
    checkCudaErrors(cudaMallocManaged((void **)&d_rand_state2, 1*sizeof(curandState))); //regular malloc
